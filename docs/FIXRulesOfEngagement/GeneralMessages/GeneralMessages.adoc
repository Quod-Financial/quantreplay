...
[[general-application-msg]]
== General Application Messages

[[general-application-msg-sec-sts-req]]
...
[[general-application-msg-sec-sts-resp]]
...
Changes to phase occurs across the entire venue. In any case, the phase will always be reported by listing. 
...
| 336 | TradingSessionID | N a| Trading session identifier.

* 1 - Day

| 625 | TradingSessionSubID | N a| Sub-identifier for the active trading phase within a trading session.
...
[[general-application-msg-bus-msg-rej]]
