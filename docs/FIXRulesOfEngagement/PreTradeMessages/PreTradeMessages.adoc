...
* B - Trade Volume (quantity, with its volume MDEntrySize)
* H - Mid Price
* P - Early Prices (price, with its volume in MDEntrySize)
* Q - Auction Clearing Price (price, with its volume in MDEntrySize)
* b - Market Bid
* c - Market Offer
...
* e - Previous Closing Price
* Q - Auction Clearing Price (price, with its volume in MDEntrySize)
* P - Early Price (price, with its volume in MDEntrySize; see <<message-flows-mkt-data-auction>>)
* B - Trade Volume (daily traded volume in MDEntrySize, without a price; see <<message-flows-mkt-data-daily-reset>>)
...
| => 277 | TradeCondition | a| Side of the imbalance. _These imbalance entries are reserved for a future release and are not currently emitted by the simulator._
