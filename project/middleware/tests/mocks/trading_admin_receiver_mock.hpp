#ifndef SIMULATOR_MIDDLEWARE_TESTS_MOCKS_TRADING_ADMIN_RECEIVER_MOCK_HPP_
#define SIMULATOR_MIDDLEWARE_TESTS_MOCKS_TRADING_ADMIN_RECEIVER_MOCK_HPP_
...
#endif  // SIMULATOR_MIDDLEWARE_TESTS_MOCKS_TRADING_ADMIN_RECEIVER_MOCK_HPP_
