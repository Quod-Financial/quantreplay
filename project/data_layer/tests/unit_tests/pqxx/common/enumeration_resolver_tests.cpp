...
TEST(DataLayer_Pqxx_EnumerationResolver_DatasourceFromat, String_Undefined) {
  ...
  EXPECT_THROW((void)resolver(
                   data_layer::test::invalid_enum_value<Datasource::Format>()),
               EnumEncodingError);
}
...
TEST(DataLayer_Pqxx_EnumerationResolver_DatasourceType, String_Undefined) {
  constexpr EnumerationResolver resolver;
  EXPECT_THROW(
      (void)resolver(data_layer::test::invalid_enum_value<Datasource::Type>()),
      EnumEncodingError);
}
...
TEST(DataLayer_Pqxx_EnumerationResolver_DatasourceType, Value_Undefined) {
  constexpr EnumerationResolver resolver;
  auto type = data_layer::test::invalid_enum_value<Datasource::Type>();
...
TEST(DataLayer_Pqxx_EnumerationResolver_MarketPhase, String_Undefined) {
  constexpr EnumerationResolver resolver;
  EXPECT_THROW((void)resolver(
                   data_layer::test::invalid_enum_value<MarketPhase::Phase>()),
               EnumEncodingError);
}
...
TEST(DataLayer_Pqxx_EnumerationResolver_MarketPhase, Value_Undefined) {
  constexpr EnumerationResolver resolver;
  auto type = data_layer::test::invalid_enum_value<MarketPhase::Phase>();
...
TEST(DataLayer_Pqxx_EnumerationResolver_VenueEngineType, String_Undefined) {
  constexpr EnumerationResolver resolver;
  EXPECT_THROW(
      (void)resolver(data_layer::test::invalid_enum_value<Venue::EngineType>()),
      EnumEncodingError);
}
...
TEST(DataLayer_Pqxx_EnumerationResolver_VenueEngineType, Value_Undefined) {
  constexpr EnumerationResolver resolver;
  auto engine_type = data_layer::test::invalid_enum_value<Venue::EngineType>();
