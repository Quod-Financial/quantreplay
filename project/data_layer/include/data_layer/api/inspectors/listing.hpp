...
inline auto ListingPatchReader<Marshaller>::read(const Listing::Patch& patch)
  ...
  if (const auto& value = patch.enabled_flag()) {
    ...
    marshaller_(Attribute::Enabled,
                value.inner_value_or(Listing::DefaultEnabledFlag));
  }
  ...
  if (const auto& value = patch.random_orders_enabled_flag()) {
    static_assert(
        can_marshall_v<std::remove_cvref_t<decltype(value)>::value_type>);
    marshaller_(Attribute::RandomOrdersEnabled,
                value.inner_value_or(Listing::DefaultRandomOrdersEnabledFlag));
  }
...
inline auto ListingPatchWriter<Unmarshaller>::write(Listing::Patch& patch)
  ...
  std::optional<std::string> fx_base_currency;
  ...
  std::optional<std::string> instr_symbol;
  ...
  std::optional<double> qty_minimum;
  ...
  std::optional<double> qty_maximum;
  ...
  std::optional<double> qty_multiple;
  ...
  std::optional<double> price_tick_size;
  ...
  std::optional<double> random_qty_maximum;
  ...
  std::optional<double> random_orders_spread;
  ...
  std::optional<std::uint32_t> random_orders_rate;
  ...
  std::optional<std::uint32_t> random_tick_range;
  ...
  std::optional<std::string> party_role;
  ...
  std::optional<std::string> cusip_id;
  ...
  std::optional<std::string> sedol_id;
  ...
  std::optional<std::string> isin_id;
  ...
  std::optional<std::string> bloomberg_symbol_id;
  ...
  std::optional<double> random_qty_minimum;
  ...
  std::optional<double> random_amt_minimum;
  ...
  std::optional<double> random_amt_maximum;
  ...
  std::optional<bool> random_orders_enabled;
  ...
  std::optional<double> random_aggressive_qty_minimum;
  ...
  std::optional<double> random_aggressive_qty_maximum;
  ...
  std::optional<double> random_aggressive_amt_minimum;
  ...
  std::optional<double> random_aggressive_amt_maximum;
