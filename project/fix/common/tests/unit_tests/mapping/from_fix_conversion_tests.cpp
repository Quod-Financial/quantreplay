...
INSTANTIATE_TEST_SUITE_P(FixValues, FromFixPartyIdSourceConversion,
  Values(
    ...
    std::make_tuple(FIX::PartyIDSource_KOREA_SHORT_SELLING_REGISTRATION_NUMBER, PartyIdSource::Option::KoreaShortSellingRegistrationNumber)
  ));
// clang-format on
...
INSTANTIATE_TEST_SUITE_P(FixValues, FromFixPartyRoleConversion,
  Values(
    ...
    std::make_tuple(FIX::PartyRole_GIVEUP_CLEARING_FIRM_DEPR, PartyRole::Option::GiveupClearingFirmDepr),
    ...
    std::make_tuple(FIX::PartyRole_BUYER_SELLER, PartyRole::Option::Buyer),
    ...
    std::make_tuple(FIX::PartyRole_CONTRA_INVESTOR_ID, PartyRole::Option::ContraInvestorID),
    std::make_tuple(FIX::PartyRole_TRANSFER_TO_FIRM, PartyRole::Option::TransferToFirm),
    std::make_tuple(FIX::PartyRole_CONTRA_POSITION_ACCOUNT, PartyRole::Option::ContraPositionAccount),
    ...
    std::make_tuple(FIX::PartyRole_CLS_MEMBER_BANK, PartyRole::Option::CLSMemberBank),
    std::make_tuple(FIX::PartyRole_IN_CONCERT_GROUP, PartyRole::Option::InConcertGroup),
    std::make_tuple(FIX::PartyRole_IN_CONCERT_CONTROLLING_ENTITY, PartyRole::Option::InConcertControllingEntity),
    std::make_tuple(FIX::PartyRole_LARGE_POSITIONS_REPORTING_ACCOUNT, PartyRole::Option::LargePositionsReportingAccount),
    std::make_tuple(FIX::PartyRole_SETTLEMENT_FIRM, PartyRole::Option::SettlementFirm),
    std::make_tuple(FIX::PartyRole_SETTLEMENT_ACCOUNT, PartyRole::Option::SettlementAccount),
    std::make_tuple(FIX::PartyRole_REPORTING_MARKET_CENTER, PartyRole::Option::ReportingMarketCenter),
    std::make_tuple(FIX::PartyRole_RELATED_REPORTING_MARKET_CENTER, PartyRole::Option::RelatedReportingMarketCenter),
    std::make_tuple(FIX::PartyRole_AWAY_MARKET, PartyRole::Option::AwayMarket),
    std::make_tuple(FIX::PartyRole_GIVEUP_TRADING_FIRM, PartyRole::Option::GiveupTradingFirm),
    std::make_tuple(FIX::PartyRole_TAKEUP_TRADING_FIRM, PartyRole::Option::TakeupTradingFirm),
    std::make_tuple(FIX::NEW_PartyRole_GIVEUP_CLEARING_FIRM, PartyRole::Option::GiveupClearingFirm),
    std::make_tuple(FIX::PartyRole_TAKEUP_CLEARING_FIRM, PartyRole::Option::TakeupClearingFirm),
    std::make_tuple(FIX::PartyRole_ORIGINATING_MARKET, PartyRole::Option::OriginatingMarket),
    std::make_tuple(FIX::PartyRole_MARGIN_ACCOUNT, PartyRole::Option::MarginAccount),
    std::make_tuple(FIX::PartyRole_COLLATERAL_ASSET_ACCOUNT, PartyRole::Option::CollateralAssetAccount),
    std::make_tuple(FIX::PartyRole_DATA_REPOSITORY, PartyRole::Option::DataRepository),
    std::make_tuple(FIX::PartyRole_CALCULATION_AGENT, PartyRole::Option::CalculationAgent),
    std::make_tuple(FIX::PartyRole_EXERCISE_NOTICE_SENDER, PartyRole::Option::ExerciseNoticeSender),
    std::make_tuple(FIX::PartyRole_EXERCISE_NOTICE_RECEIVER, PartyRole::Option::ExerciseNoticeReceiver),
    std::make_tuple(FIX::PartyRole_RATE_REFERENCE_BANK, PartyRole::Option::RateReferenceBank),
    std::make_tuple(FIX::PartyRole_CORRESPONDENT, PartyRole::Option::Correspondent),
    std::make_tuple(FIX::PartyRole_BENEFICIARY_BANK, PartyRole::Option::BeneficiaryBank),
    std::make_tuple(FIX::PartyRole_BORROWER, PartyRole::Option::Borrower),
    std::make_tuple(FIX::PartyRole_PRIMARY_OBLIGATOR, PartyRole::Option::PrimaryObligator),
    std::make_tuple(FIX::PartyRole_GUARANTOR, PartyRole::Option::Guarantor),
    std::make_tuple(FIX::PartyRole_EXCLUDED_REFERENCE_ENTITY, PartyRole::Option::ExcludedReferenceEntity),
    std::make_tuple(FIX::PartyRole_DETERMINING_PARTY, PartyRole::Option::DeterminingParty),
    std::make_tuple(FIX::PartyRole_HEDGING_PARTY, PartyRole::Option::HedgingParty),
    std::make_tuple(FIX::PartyRole_REPORTING_ENTITY, PartyRole::Option::ReportingEntity),
    std::make_tuple(FIX::PartyRole_SALES_PERSON, PartyRole::Option::SalesPerson),
    std::make_tuple(FIX::PartyRole_OPERATOR, PartyRole::Option::Operator),
    std::make_tuple(FIX::PartyRole_CSD, PartyRole::Option::CSD),
    std::make_tuple(FIX::PartyRole_ICSD, PartyRole::Option::ICSD),
    std::make_tuple(FIX::PartyRole_TRADING_SUB_ACCOUNT, PartyRole::Option::TradingSubAccount),
    std::make_tuple(FIX::PartyRole_INVESTMENT_DECISION_MAKER, PartyRole::Option::InvestmentDecisionMaker),
    std::make_tuple(FIX::PartyRole_PUBLISHING_INTERMEDIARY, PartyRole::Option::PublishingIntermediary),
    std::make_tuple(FIX::PartyRole_CSD_PARTICIPANT, PartyRole::Option::CSDParticipant),
    std::make_tuple(FIX::PartyRole_ISSUER, PartyRole::Option::Issuer),
    std::make_tuple(FIX::PartyRole_CONTRA_CUSTOMER_ACCOUNT, PartyRole::Option::ContraCustomerAccount),
    std::make_tuple(FIX::PartyRole_CONTRA_INVESTMENT_DECISION_MAKER, PartyRole::Option::ContraInvestmentDecisionMaker),
    std::make_tuple(FIX::PartyRole_AUTHORIZING_PERSON, PartyRole::Option::AuthorizingPerson),
    std::make_tuple(FIX::PartyRole_PRIMARY_PLACE_OF_LISTING, PartyRole::Option::PrimaryPlaceOfListing),
    std::make_tuple(FIX::PartyRole_SECONDARY_PLACE_OF_LISTING, PartyRole::Option::SecondaryPlaceOfListing)
  ));
// clang-format on
