#ifndef SIMULATOR_TRADING_SYSTEM_ACCEPTOR_TESTS_MOCKS_FROM_FIX_MAPPER_STUB_HPP_
#define SIMULATOR_TRADING_SYSTEM_ACCEPTOR_TESTS_MOCKS_FROM_FIX_MAPPER_STUB_HPP_
...
#endif  // SIMULATOR_TRADING_SYSTEM_ACCEPTOR_TESTS_MOCKS_FROM_FIX_MAPPER_STUB_HPP_