...
struct AcceptorAppReplySender : Test {
  ...
  StrictMock<MessageSenderMock> reply_sender;
...
TEST_F(AcceptorAppReplySender, SendsExecutionReportAsIs) {
  ...
  EXPECT_CALL(reply_sender, send_message(_, _));
...
TEST_F(AcceptorAppReplySender,
  ...
  EXPECT_CALL(reply_sender,
              send_message(MsgTypeIs(FIX::MsgType_ExecutionReport), _));
...
TEST_F(AcceptorAppReplySender,
  ...
  EXPECT_CALL(reply_sender,
              send_message(MsgTypeIs(FIX::MsgType_OrderCancelReject), _));
...
TEST_F(AcceptorAppReplySender, SendsMarketDataRejectAsMarketDataRequestReject) {
  ...
  EXPECT_CALL(reply_sender,
              send_message(MsgTypeIs(FIX::MsgType_MarketDataRequestReject), _));
...
TEST_F(AcceptorAppReplySender,
  ...
  EXPECT_CALL(
      reply_sender,
      send_message(MsgTypeIs(FIX::MsgType_MarketDataSnapshotFullRefresh), _));
...
TEST_F(AcceptorAppReplySender,
  ...
  EXPECT_CALL(
      reply_sender,
      send_message(MsgTypeIs(FIX::MsgType_MarketDataIncrementalRefresh), _));
