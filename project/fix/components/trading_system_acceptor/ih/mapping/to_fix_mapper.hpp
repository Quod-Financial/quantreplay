#ifndef SIMULATOR_TRADING_SYSTEM_ACCEPTOR_IH_MAPPING_TO_FIX_MAPPER_HPP_
#define SIMULATOR_TRADING_SYSTEM_ACCEPTOR_IH_MAPPING_TO_FIX_MAPPER_HPP_
...
#endif  // SIMULATOR_TRADING_SYSTEM_ACCEPTOR_IH_MAPPING_TO_FIX_MAPPER_HPP_
