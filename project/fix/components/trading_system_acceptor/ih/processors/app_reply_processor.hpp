#ifndef SIMULATOR_TRADING_SYSTEM_ACCEPTOR_IH_PROCESSORS_APP_REPLY_PROCESSOR_HPP_
#define SIMULATOR_TRADING_SYSTEM_ACCEPTOR_IH_PROCESSORS_APP_REPLY_PROCESSOR_HPP_
...
class AppReplyProcessor {
 public:
  AppReplyProcessor(const MessageSender& reply_sender,
 ...
 private:
  ...
  std::reference_wrapper<const MessageSender> reply_sender_;
};
...
auto AppReplyProcessor<Mapper>::send_as(
  ...
  reply_sender_.get().send_message(fix_message, fix_session);
}

}  // namespace simulator::fix::trading_system_acceptor

#endif  // SIMULATOR_TRADING_SYSTEM_ACCEPTOR_IH_PROCESSORS_APP_REPLY_PROCESSOR_HPP_