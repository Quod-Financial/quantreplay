#ifndef SIMULATOR_TRADING_SYSTEM_ACCEPTOR_IH_PROCESSORS_APP_REQUEST_PROCESSOR_HPP_
#define SIMULATOR_TRADING_SYSTEM_ACCEPTOR_IH_PROCESSORS_APP_REQUEST_PROCESSOR_HPP_
...
class AppRequestProcessor final : public MessageProcessor {
 public:
...
template <typename MapperType>
  requires RequestMapperConcept<MapperType>
auto AppRequestProcessor<MapperType>::process_message(
...
#endif  // SIMULATOR_TRADING_SYSTEM_ACCEPTOR_IH_PROCESSORS_APP_REQUEST_PROCESSOR_HPP_