...
namespace simulator::fix::trading_system_acceptor::detail {
...
auto make_party_id_source_mapping_association()
  ...
  return {
      ...
      {FIX::PartyIDSource_KOREA_SHORT_SELLING_REGISTRATION_NUMBER, PartyIdSource::Option::KoreaShortSellingRegistrationNumber}};
  // clang-format on
}
...
auto make_party_role_mapping_association()
  ...
  return {
      ...
      {FIX::PartyRole_GIVEUP_CLEARING_FIRM_DEPR, PartyRole::Option::GiveupClearingFirmDepr},
      ...
      {FIX::PartyRole_BUYER_SELLER, PartyRole::Option::Buyer},
      ...
      {FIX::PartyRole_CONTRA_INVESTOR_ID, PartyRole::Option::ContraInvestorID},
      {FIX::PartyRole_TRANSFER_TO_FIRM, PartyRole::Option::TransferToFirm},
      {FIX::PartyRole_CONTRA_POSITION_ACCOUNT, PartyRole::Option::ContraPositionAccount},
      ...
      {FIX::PartyRole_CLS_MEMBER_BANK, PartyRole::Option::CLSMemberBank},
      {FIX::PartyRole_IN_CONCERT_GROUP, PartyRole::Option::InConcertGroup},
      {FIX::PartyRole_IN_CONCERT_CONTROLLING_ENTITY, PartyRole::Option::InConcertControllingEntity},
      {FIX::PartyRole_LARGE_POSITIONS_REPORTING_ACCOUNT, PartyRole::Option::LargePositionsReportingAccount},
      {FIX::PartyRole_SETTLEMENT_FIRM, PartyRole::Option::SettlementFirm},
      {FIX::PartyRole_SETTLEMENT_ACCOUNT, PartyRole::Option::SettlementAccount},
      {FIX::PartyRole_REPORTING_MARKET_CENTER, PartyRole::Option::ReportingMarketCenter},
      {FIX::PartyRole_RELATED_REPORTING_MARKET_CENTER, PartyRole::Option::RelatedReportingMarketCenter},
      {FIX::PartyRole_AWAY_MARKET, PartyRole::Option::AwayMarket},
      {FIX::PartyRole_GIVEUP_TRADING_FIRM, PartyRole::Option::GiveupTradingFirm},
      {FIX::PartyRole_TAKEUP_TRADING_FIRM, PartyRole::Option::TakeupTradingFirm},
      {FIX::NEW_PartyRole_GIVEUP_CLEARING_FIRM, PartyRole::Option::GiveupClearingFirm},
      {FIX::PartyRole_TAKEUP_CLEARING_FIRM, PartyRole::Option::TakeupClearingFirm},
      {FIX::PartyRole_ORIGINATING_MARKET, PartyRole::Option::OriginatingMarket},
      {FIX::PartyRole_MARGIN_ACCOUNT, PartyRole::Option::MarginAccount},
      {FIX::PartyRole_COLLATERAL_ASSET_ACCOUNT, PartyRole::Option::CollateralAssetAccount},
      {FIX::PartyRole_DATA_REPOSITORY, PartyRole::Option::DataRepository},
      {FIX::PartyRole_CALCULATION_AGENT, PartyRole::Option::CalculationAgent},
      {FIX::PartyRole_EXERCISE_NOTICE_SENDER, PartyRole::Option::ExerciseNoticeSender},
      {FIX::PartyRole_EXERCISE_NOTICE_RECEIVER, PartyRole::Option::ExerciseNoticeReceiver},
      {FIX::PartyRole_RATE_REFERENCE_BANK, PartyRole::Option::RateReferenceBank},
      {FIX::PartyRole_CORRESPONDENT, PartyRole::Option::Correspondent},
      {FIX::PartyRole_BENEFICIARY_BANK, PartyRole::Option::BeneficiaryBank},
      {FIX::PartyRole_BORROWER, PartyRole::Option::Borrower},
      {FIX::PartyRole_PRIMARY_OBLIGATOR, PartyRole::Option::PrimaryObligator},
      {FIX::PartyRole_GUARANTOR, PartyRole::Option::Guarantor},
      {FIX::PartyRole_EXCLUDED_REFERENCE_ENTITY, PartyRole::Option::ExcludedReferenceEntity},
      {FIX::PartyRole_DETERMINING_PARTY, PartyRole::Option::DeterminingParty},
      {FIX::PartyRole_HEDGING_PARTY, PartyRole::Option::HedgingParty},
      {FIX::PartyRole_REPORTING_ENTITY, PartyRole::Option::ReportingEntity},
      {FIX::PartyRole_SALES_PERSON, PartyRole::Option::SalesPerson},
      {FIX::PartyRole_OPERATOR, PartyRole::Option::Operator},
      {FIX::PartyRole_CSD, PartyRole::Option::CSD},
      {FIX::PartyRole_ICSD, PartyRole::Option::ICSD},
      {FIX::PartyRole_TRADING_SUB_ACCOUNT, PartyRole::Option::TradingSubAccount},
      {FIX::PartyRole_INVESTMENT_DECISION_MAKER, PartyRole::Option::InvestmentDecisionMaker},
      {FIX::PartyRole_PUBLISHING_INTERMEDIARY, PartyRole::Option::PublishingIntermediary},
      {FIX::PartyRole_CSD_PARTICIPANT, PartyRole::Option::CSDParticipant},
      {FIX::PartyRole_ISSUER, PartyRole::Option::Issuer},
      {FIX::PartyRole_CONTRA_CUSTOMER_ACCOUNT, PartyRole::Option::ContraCustomerAccount},
      {FIX::PartyRole_CONTRA_INVESTMENT_DECISION_MAKER, PartyRole::Option::ContraInvestmentDecisionMaker},
      {FIX::PartyRole_AUTHORIZING_PERSON, PartyRole::Option::AuthorizingPerson},
      {FIX::PartyRole_PRIMARY_PLACE_OF_LISTING, PartyRole::Option::PrimaryPlaceOfListing},
      {FIX::PartyRole_SECONDARY_PLACE_OF_LISTING, PartyRole::Option::SecondaryPlaceOfListing}};
  // clang-format on
}
