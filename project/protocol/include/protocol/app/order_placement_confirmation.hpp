#ifndef SIMULATOR_PROTOCOL_APP_ORDER_PLACEMENT_CONFIRMATION_HPP_
#define SIMULATOR_PROTOCOL_APP_ORDER_PLACEMENT_CONFIRMATION_HPP_
...
struct OrderPlacementConfirmation {
  explicit OrderPlacementConfirmation(Session protocol_session) noexcept;
...
template <>
struct fmt::formatter<simulator::protocol::OrderPlacementConfirmation> {
  using formattable = simulator::protocol::OrderPlacementConfirmation;
...
#endif  // SIMULATOR_PROTOCOL_APP_ORDER_PLACEMENT_CONFIRMATION_HPP_