#ifndef SIMULATOR_PROTOCOL_APP_ORDER_MODIFICATION_CONFIRMATION_HPP_
#define SIMULATOR_PROTOCOL_APP_ORDER_MODIFICATION_CONFIRMATION_HPP_
...
struct OrderModificationConfirmation {
  explicit OrderModificationConfirmation(Session protocol_session) noexcept;
...
template <>
struct fmt::formatter<simulator::protocol::OrderModificationConfirmation> {
  using formattable = simulator::protocol::OrderModificationConfirmation;
...
#endif  // SIMULATOR_PROTOCOL_APP_ORDER_MODIFICATION_CONFIRMATION_HPP_