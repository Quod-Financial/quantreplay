#ifndef SIMULATOR_TRADING_SYSTEM_COMPONENTS_COMMON_TESTS_TEST_UTILS_MATCHERS_HPP_
#define SIMULATOR_TRADING_SYSTEM_COMPONENTS_COMMON_TESTS_TEST_UTILS_MATCHERS_HPP_
...
#endif  // SIMULATOR_TRADING_SYSTEM_COMPONENTS_COMMON_TESTS_TEST_UTILS_MATCHERS_HPP_
