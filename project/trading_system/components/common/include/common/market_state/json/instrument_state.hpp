...
struct simulator::core::json::Struct<
  ...
  static constexpr auto fields = std::make_tuple(
      Field(
          &simulator::trading_system::market_state::InstrumentState::instrument,
          "instrument"),
      Field(
          &simulator::trading_system::market_state::InstrumentState::last_trade,
          "last_trade"),
      Field(&simulator::trading_system::market_state::InstrumentState::info,
            "info"),
      Field(
          &simulator::trading_system::market_state::InstrumentState::order_book,
          "order_book"));
};
