#ifndef SIMULATOR_TRADING_SYSTEM_TESTS_TEST_UTILS_UTILS_HPP_
#define SIMULATOR_TRADING_SYSTEM_TESTS_TEST_UTILS_UTILS_HPP_
...
#endif  // SIMULATOR_TRADING_SYSTEM_TESTS_TEST_UTILS_UTILS_HPP_
